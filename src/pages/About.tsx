            ...
            >
              ...
              <div className="prose prose-lg text-muted-foreground space-y-4 mb-8">
                <p>
                  ...
                  από 15 χρόνια εμπειρίας στη σύγχρονη αγγειοχειρουργική και τις ενδαγγειακές τεχνικές.
                </p>
                <p>
                  Αποφοίτησε από την Ιατρική Σχολή του Δημοκριτείου Πανεπιστημίου Θράκης και 
                  εξειδικεύτηκε περαιτέρω στα Oxford University Hospitals στο Ηνωμένο Βασίλειο.
                </p>
                <p>
                  Διαθέτει μεταπτυχιακό δίπλωμα στις Ενδαγγειακές Τεχνικές από το Εθνικό και 
                  Καποδιστριακό Πανεπιστήμιο Αθηνών και συνεχίζει να επιμορφώνεται σε νέες 
